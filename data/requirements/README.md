...
Если для требования нет однозначной исторической формулировки, каталог добавляет безопасный прямой пункт из текста самого утверждённого требования. Он обеспечивает полноту нормативного покрытия без смысловой интерпретации; ИИ впоследствии может предложить более короткую формулировку, но не изменить применимость или основание.
