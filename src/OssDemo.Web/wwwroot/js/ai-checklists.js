(() => {
  ...
  const finish = async () => {
    ...
    try {
      ...
      showStep(4);
    } catch (error) { showError('[data-ai-generation-error]', error); finalizing = false; }
  };
  const poll = async () => {
