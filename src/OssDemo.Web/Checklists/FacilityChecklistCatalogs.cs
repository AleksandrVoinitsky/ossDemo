internal sealed class FacilityChecklistCatalogs
{
    public FacilityChecklistCatalogs()
    {
        ...
        var templatePath = Path.Combine(directory, "inspector-checklist-template.jsonl");
        Controls = InspectionControlCatalog.Build(
            InspectorChecklistTemplate.ParseLines(File.ReadLines(templatePath)), Items);
